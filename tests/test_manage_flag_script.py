...
class TestFormatCommand:
    ...
    def test_format_command_prefix_only(self, capsys):
        ...
        with patch("manage_flag.GameConfig") as mock_config_class:
            ...
            # Set up mock return values
            mock_config.get.side_effect = lambda key: {"victory.flag_prefix": "FLAG{", "victory.flag_suffix": "}"}.get(
                key
            )
    ...
    def test_format_command_both_prefix_and_suffix(self, capsys):
        ...
        with patch("manage_flag.GameConfig") as mock_config_class:
            ...
            # Verify config was updated
            expected_calls = [(("victory.flag_prefix", "CTF{"),), (("victory.flag_suffix", "]"),)]
...
class TestMainFunction:
    ...
    def test_main_invalid_command(self, capsys):
        ...
        with patch("sys.argv", ["manage_flag.py", "invalid"]), pytest.raises(SystemExit):
            manage_flag.main()
