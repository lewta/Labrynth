...
class TestGameEngineInitialization:
    ...
    def test_initialize_game_engine_default(self, mock_engine_class, mock_setup_logging):
        ...
        mock_setup_logging.assert_called_once_with(debug=False, verbose=False, log_file=None)
        mock_engine_class.assert_called_once_with(config_file=None, use_colors=True)
    ...
    def test_initialize_game_engine_with_config(self, mock_engine_class, mock_setup_logging, mock_create_log):
        ...
        mock_setup_logging.assert_called_once_with(debug=True, verbose=False, log_file="logs/test.log")
        mock_engine_class.assert_called_once_with(config_file="custom.json", use_colors=False)
        assert result == mock_engine
