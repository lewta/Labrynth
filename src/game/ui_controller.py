...
class UIController:
    ...
    def __init__(self, use_colors: bool = True, input_handler: Callable[[str], str] | None = None):
...
"""
    ...
    def get_save_filename(self) -> str | None:
    ...
    def get_load_filename(self, save_files: list[str]) -> str | None:
